...
const DC_GAMES = [
  ...
  { id: 'wordle', emoji: '🔠', label: 'Wordle du jour', subtitle: 'Défi quotidien', route: '/jeux/wordle', available: false },
  { id: 'sudoku', emoji: '🔢', label: 'Sudoku Race', subtitle: 'Le plus rapide gagne', route: '/jeux/sudoku', available: false },
