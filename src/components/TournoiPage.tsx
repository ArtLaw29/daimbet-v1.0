    ...
    <div className="space-y-4">
      <div className="text-center mb-2">
        ...
        <p className="text-xs text-muted-foreground max-w-md mx-auto mt-2">
          Bienvenue dans l'arène de You Decide — Tournois ! Parie sur celui qui soulèvera le trophée final pour gagner des DAIMcoins. Une fois la compétition lancée, vote gratuitement à chaque tour pour aider ton favori à progresser dans le tableau. Si ton champion triomphe en finale, tu empoches ta part de la cagnotte !
        </p>
      </div>
