...
const GLOSSARY: { term: string; definition: string }[] = [
  { term: 'DAIMcoin (DC)', definition: 'Monnaie virtuelle fictive de la plateforme. Capital de départ : 1 000 DC par joueur.' },
  ...
  { term: 'Rake', definition: 'Commission de 5 % prélevée sur les gains nets (gain brut − mise). Jamais sur la mise elle-même.' },
  ...
  { term: 'Réinitialisation nucléaire', definition: 'Remise à zéro totale de la plateforme (soldes, paris, mises). Irréversible. Protégée par 3 étapes de confirmation.' },
  ...
  { term: 'Ticket support', definition: 'Système de messagerie entre un joueur et Jordaim Belfort pour signaler un problème.' },
